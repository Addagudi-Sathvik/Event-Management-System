...
import { registerForEvent } from "../api/registration.api";
...
export default function EventDetailsPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      toast.success(`Registered! Confirmation: ${res.registration.confirmationNumber}`);
      setEvent((prev) => ({
        ...prev,
        currentRegisteredCount: prev.currentRegisteredCount + 1,
      }));
    } catch (error) {
